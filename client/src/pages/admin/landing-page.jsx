...
function LandingPage() {
  ...
  const handleSubmit = async () => {
    ...
    return (
        <div className='w-full' >
                        <div className={`${isScrolled ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'} bg-[#082f57] transition-all duration-800 fixed top-0 right-0 left-0 z-50 `}>
             ...
             <div className={` bg-[#082f57] duration-300 marker:w-full z-40`}>
                <div className="flex items-center justify-between py-10 h-16 gap-10 max-w-[1300px] mx-auto">
                    <div className="h-12">
                     <img src={'/assets/logo2.png'} alt="logo" className="h-full" />
                    </div>
                    <ul className="flex items-center">
                        <li className="mr-8 text-lg text-white font-medium hover:text-[#6aca8e] cursor-pointer">
                            <ScrollLink to="home" smooth={true} duration={500}>home</ScrollLink>
                        </li>
                        <li className="mr-8 text-lg text-white font-semibold hover:text-[#6aca8e] cursor-pointer">
                        <ScrollLink to="about" smooth={true} duration={500}>about</ScrollLink>
                ...
                <div className="w-full pt-24 bg-[#082f57]" >
                    <div className="flex items-center justify-between  gap-10 max-w-[1300px] mx-auto pt-24 ">
                      <div className='basis-1/2 flex flex-col '>
                        <h1 className='text-5xl font-extrabold text-[#fff] mb-5'>Premiere agence de confirmation au <span className="text-[#082f57]">marche</span></h1>
                ...
                <div className="w-full mt-10 ">
                    <div className="flex items-center justify-between  gap-10 max-w-[1300px] mx-auto py-24">
                      ...
                      <div className='basis-1/2 flex flex-col '>
                        <p className="text-sm font-extrabold text-[#6aca8e] mb-1">Who We Are</p>
                        ...
                        <button className='bg-[#082f57] text-[#fff] text-lg py-3 px-8 font-bold w-fit rounded-xl'>Contact Us</button>
                      </div>
                    </div>
                </div>
                {/* <div className="w-full bg-[#edf3ff] pb-20"> */}
                <div className="w-full bg-[#dde6e0] pb-20">
                    <div className="max-w-[1300px] mx-auto py-24 ">
                        <p className="text-sm font-extrabold text-[#ff7400]">What We Do</p>
                        <div className="flex items-start justify-between gap-16">
                                <h4 className="text-4xl font-extrabold text-[#173c5f] basis-2/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full mt-10">
                            <div className='group py-8 px-2 pl-8 rounded-2xl   bg-[#fff]  cursor-pointer flex flex-col hover:scale-105 '>
                                <div className='w-14 h-14 rounded-3xl flex items-center justify-center bg-[#f6f5f8] mb-4 '>
                                    <Headset   color='#082f57' size={30} className=''/> 
                                </div>
                            ...
                            <div className='group py-8 px-2 pl-8 rounded-2xl   bg-[#fff]  cursor-pointer flex flex-col hover:scale-105 '>
                                <div className='w-14 h-14 rounded-3xl flex items-center justify-center bg-[#f6f5f8] mb-4 '>
                                    <Play  color='#f3772e' size={30} className=''/> 
                                </div>
                                <div className="flex flex-col basis-2/3 ">
                                    <h3 className='text-xl font-bold mb-3 text-[#414141] '>Video Ads</h3>
                                    <p className="text-md text-gray-600 ">we can create standing UGC video for your E-commerce brand</p>
                            ...
                            <div className='group py-8 px-2 pl-8 rounded-2xl   bg-[#fff]  cursor-pointer flex flex-col hover:scale-105'>
                                <div className='w-14 h-14 rounded-3xl flex items-center justify-center bg-[#f5f8f6] mb-4 '>
                                    <Play  color='#31e97e' size={30} className=''/> 
                                </div>
                                <div className="flex flex-col basis-2/3 ">
                                    <h3 className='text-xl font-bold mb-3 text-[#414141] '>Video Ads</h3>
                                    <p className="text-md text-gray-600 ">we can create standing UGC video for your E-commerce brand</p>
                ...
                <div className="w-full bg-[#fe7300]">
                    <div className="flex items-center justify-between gap-10 max-w-[1300px] mx-auto ">
                        <div className='basis-1/2 flex flex-col '>
                            <h1 className='text-[57px] font-bold text-[#fff] mb-4 leading-[3.5rem]'>Premiere agence de confirmation</h1>
                ...
                <div className="w-full py-36 bg-[#edf3ff]">
                    <div className="flex items-start justify-between gap-10 max-w-[1300px] mx-auto">
                        <div className='basis-2/5 flex flex-col'>
                            <p className="text-md font-bold text-[#ff7400] mb-1">STEPS</p>
                            ...
                            <button className='bg-[#082f57] text-[#fff] text-lg py-3 px-8 font-bold w-fit rounded-xl'>Start Now</button>
                        </div>
                        <div className='basis-3/5 grid grid-cols-2 gap-10'>
                            <div className="border-[2px] border-gray-100 px-6 py-8 flex flex-col rounded-2xl bg-[#fff] cursor-pointer hover:-translate-y-2 ">
                                <div className="rounded w-12 h-12 flex items-center justify-center bg-[#082f57] mb-6">
 ...
 {/* section Contact  */}
        <div className='w-full pt-24  '  id='contact'>
                <div className='w-full max-w-[1300px] mx-auto flex flex-col items-center  px-15  '>
                   ...
                   <div className='flex items-center justify-center gap-16 w-full mb-14'>
                        ...
                        <div className='basis-1/2 flex flex-col '>
                                ...
                                <button className='border-[3px] border-[#082f57]  text-white  bg-[#082f57] py-2 px-8 text-lg font-bold w-fit rounded' onClick={handleSubmit}>Contact</button>
                        </div>
                   </div>
                </div>                  
            </div>
            ...
            <div className='w-full bg-[#082f57] pb-10'  id='footer'>
